      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            {/* Left — Three.js visualization (placeholder) */}
            <div className="w-full aspect-square bg-gray-200/50 rounded-lg border border-white/30 flex items-center justify-center">
              <span className="text-gray-400 text-sm">Three.js Visualization</span>
            </div>
